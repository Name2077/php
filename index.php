...
<form  class="" action="index.php" method="post" enctype="multipart/form-data">
  <center><input type="search" name="login" value="" placeholder="Сообщение" id="login" autocomplete="formtarget"></center>
